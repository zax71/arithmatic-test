...
class TestOperations(unittest.TestCase):
    ...
    def test_add_calculate(self):
        self.assertEqual(
            Operations.ADD.calculate(self._n1, self._n2), self._n1 + self._n2
        )
    ...
    def test_subtract_calculate(self):
        self.assertEqual(
            Operations.SUBTRACT.calculate(self._n1, self._n2), self._n1 - self._n2
        )
    ...
    def test_multiply_calculate(self):
        self.assertEqual(
            Operations.MULTIPLY.calculate(self._n1, self._n2), self._n1 * self._n2
        )
    ...
    def test_divide_calculate(self):
        self.assertEqual(
            Operations.DIVIDE.calculate(self._n1, self._n2), self._n1 / self._n2
        )
